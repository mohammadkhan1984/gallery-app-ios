...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Gallory",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Gallory11AppDelegate")
...
SWIFT_CLASS("_TtC7Gallory13SceneDelegate")
...
SWIFT_CLASS("_TtC7Gallory14ViewController")
@interface ViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified GalloryCV;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7Gallory25galloryCollectionViewCell")
@interface galloryCollectionViewCell : UICollectionViewCell
